...
# load(file = "./temp/gbifIDs.Rdata") # if you need to read it from local drive
...
# load(file = "./outputs/metadata.Rdata") # if you need to read it from local drive
...
# load(file = "./temp/gbif_data.Rdata") # if you need to read it from the local file later
